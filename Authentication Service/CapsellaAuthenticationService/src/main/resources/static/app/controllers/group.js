...
.controller('groupsController', function($http, $scope, AuthService) {
	...
	var init = function() {
		...
		$http.get('/capsella_authentication_service-dev/getFullGroups').success(function(res) {
	...
	$scope.createGroup = function() {
		...
		else
		{
			...
			$http.post('/capsella_authentication_service-dev/updateGroup', $scope.group).success(function(res) {
				$scope.group = null;
				$scope.isViewLoading = false;
				document.body.style.cursor = 'default';
				init();
