...
public class AppConfig {
	...
	public ApiConfigTemplate getProperties() {
    	...
    	return new ApiConfigTemplate(environment.getRequiredProperty("csv.server"), 
    			environment.getRequiredProperty("shapefile.server"), environment.getRequiredProperty("json.server"), environment.getRequiredProperty("relational.server"),
	...
	public class ApiConfigTemplate{
		...
		public ApiConfigTemplate(String csvServer, String shapeServer, String mongoDBServer, String relationalServer, String csvServer_uploadCSVFile, String csvServer_deleteCSVFile, String csvServer_getCSVFile,
