	            ...
	            while (rs.next()) {
	                ...
	                for (int i = 0; i < columnNames.length; i++) {
	                    ...
	                    case Types.ARRAY:
	                    	...
	                    	String[] nullable;
	                    	if(array != null)
	                    		nullable = (String[])array.getArray();
	                    	else
	                    		nullable = new String[0];
	                    	
	                    	String str = String.join(",", nullable);
	                    	jgen.writeString(str);

//	                    	jgen.writeArray(array, array.getArray(), length);
//	                    	provider.defaultSerializeValue(nullable, jgen);
	                    	if(array != null)
	                    		array.free();
	                    	break;
